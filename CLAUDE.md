...
- See `docs/usage.md` for client configuration (Claude Code, Claude Desktop, Copilot CLI) and example tool calls
- See `docs/mcp-tools.md` for the full MCP tool reference
- See `docs/supported-file-types.md` for the full list of indexed languages/docs/config formats
- See `docs/architecture.md` for the source tree and module layout
- See `docs/configuration.md` for environment variables, embedding models, and offline setup
- See `docs/technical-details.md` for embeddings, hybrid search internals, and LSP-like features
- See `docs/performance.md` for benchmarks and optimization tips
- See `docs/status.md` for current status, known limitations, and roadmap
